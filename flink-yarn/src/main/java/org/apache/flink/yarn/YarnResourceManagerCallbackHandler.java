...
/**
 * This class reacts to callbacks from the YARN Resource Manager. In order to preserve actor concurrency safety, this class simply sends corresponding messages
 * to the Yarn resource master actor.
 */
public class YarnResourceManagerCallbackHandler extends AMRMClientAsync.AbstractCallbackHandler {
	...
	public void onContainersCompleted(List<ContainerStatus> list) {
		if (yarnFrameworkMaster != null) {
			yarnFrameworkMaster.tell(new ContainersComplete(list), ActorRef.noSender());
		}
	}
	...
	public void onContainersAllocated(List<Container> containers) {
		if (yarnFrameworkMaster != null) {
			yarnFrameworkMaster.tell(new ContainersAllocated(containers), ActorRef.noSender());
		}
	}
	...
	public void onError(Throwable error) {
		if (yarnFrameworkMaster != null) {
			yarnFrameworkMaster.tell(new FatalErrorOccurred("Connection to YARN Resource Manager failed", error), ActorRef.noSender());
		}
	}
